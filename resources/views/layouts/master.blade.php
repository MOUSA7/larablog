...
<div class="page-wrapper" id="app">
                        ...
                        <a href="javascript:;" class="dropdown-toggle" data-toggle="dropdown" data-hover="dropdown"
                           data-close-others="true">
                            <img alt="" class="img-circle"
                                 src="/images/{{Auth::user()->photo ?Auth::user()->photo->file :asset('assets/pages/img/avatars/dsa') }}"/>
                            <span class="username username-hide-on-mobile"> {{Auth::user()->name}} </span>
                            <i class="fa fa-angle-down"></i>
                        </a>
                        <ul class="dropdown-menu dropdown-menu-default">
                            <li>
                                <a href="{{route('admin.users.show',auth()->user()->name)}}">
                        ...
                        <ul class="sub-menu">
                            <li class="nav-item  ">
                                <a href="{{route('admin.blogs.index')}}" class="nav-link ">
                                    <span class="title">Display Blogs</span>
                                </a>
                            </li>

                            <li class="nav-item  ">
                                <a href="{{route('admin.blogs.trash')}}" class="nav-link ">
                                    <span class="title">Trash Blogs</span>
                                </a>
                            </li>
                        </ul>
                    </li>
                        ...
                        <ul class="sub-menu">
                            <li class="nav-item  ">
                                <a href="{{route('admin.categories.index')}}" class="nav-link ">
                                    <span class="title">Display Categories</span>
                                    <span class="badge badge-success">{{$category->count()}}</span>
                                </a>
                            </li>
                            <li class="nav-item  ">
                                <a href="#" class="nav-link ">
                                    <span class="title">Trash Categories</span>
                                    {{--                                    <span class="badge badge-success">{{$category->count()}}</span>--}}
                                </a>
                            </li>
                            <li class="nav-item  ">
                        ...
                        <ul class="sub-menu">
                            <li class="nav-item  ">
                                <a href="{{route('admin.users.index')}}" class="nav-link ">
                                    <span class="title">Display Users</span>
                                </a>
                            </li>
                            <li class="nav-item  ">
                                <a href="#" class="nav-link ">
                                    <span class="title">Trash Users</span>
                                </a>
                            </li>
                        </ul>
                    </li>
    ...
    <div class="page-footer">
        <div class="page-footer-inner"> 2020 &copy; Blog Theme By
            <a target="_blank" href="http://keenthemes.com">Edwin</a> &nbsp;|&nbsp;
